...
### Published version
~~If you would rather just play with the app, check it out on [Azure websites]~~(http://cryptomaster.azurewebsites.net "CryptoMaster Homepage") (not available at the moment)
